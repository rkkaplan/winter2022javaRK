...
public class C03_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println("sb2 capacity: " + sb2.capacity()); // 30  (14 + 16)

        System.out.println("sb3 length: " + sb3.length()); // 0
        System.out.println("sb3 capacity: " + sb3.capacity()); // 10


        // append methoduyla strinbuildera ekleme yapabiliriz
        ...
        sb1.trimToSize(); //aradaki farki kirpmis oldu 40 a 40 yapti
        System.out.println("sb1 length: " + sb1.length()); // 40
