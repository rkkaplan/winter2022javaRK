...
public class C03_Remove {
    public static void main(String[] args) {
        ...
        sayi degeri girdigimizde Jav otomatik olarak sayiyi index kabul eder
         */

        // int sayi=5;
        // sayilar.remove(sayi); //IndexOutOfBoundsException

        Integer sayi=5; //Integer wrapper class i kullaninca sayi obje oldugundan , bu method caslisir
        sayilar.remove(sayi);
