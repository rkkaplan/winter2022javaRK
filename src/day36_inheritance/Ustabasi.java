...
public class Ustabasi extends Isci {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ustabasi1); // Ustabasi{isciStatu='Ustabasi', saatUcreti=15, statu='Isci', maas=3600,
                                        // persNo=0, isim='Murat', soyisim='Gokcek', adres='Adres Girilmedi', tel='Tel Girilmedi'}
    }
    @Override
