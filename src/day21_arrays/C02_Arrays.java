...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        System.out.println(arr1[1]); // Esila
         // arrayin icindeki ind1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111exi kullanarak elementlere ulasabilir ve update edebiliriz
        int arr2[]= new int[4];
